<%@page import="com.kosta.th147_4group.login.dao.MemberDAO"%>
...
<body>
	...
	<div id="content" style="margin-top: 10%; margin-left: 10%">
		<form action="join.do" method="post" class="table">
			<h2>회원가입</h2>
			<h3 class="hidden">방문페이지 로그</h3>
			<p id="breadscrumb" class="block_hlist clear">
				<img alt="Step1 개인정보 등록" src="../resources/images/step2.png" />
			</p>
			...
			<div id="join-form" class="join-form margin-large">
				...
				<dl class="join-form-row">
					...
					<input class="button" type="button" value="중복확인" onclick="idchk()"/>
				</dl>
				<p id="idChk"></p>
				...
				<dl class="join-form-row">
					...
					<dd class="join-form-data">
						<span>교사는 담당반을 학부모는 자녀의 반을 선택하세요</span> 
						<select name="grade">
