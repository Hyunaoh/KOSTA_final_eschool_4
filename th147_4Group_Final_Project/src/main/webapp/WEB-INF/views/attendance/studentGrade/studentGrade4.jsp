		...
		<div id="attendance">
			<ul>
				...
				<li><a href="attendance.do?atGrade=4">4학년</a>
					<ul>
						<li><a href="studentView.do?atGrade=4&atClass=1">1반</a></li>
						<li><a href="studentView.do?atGrade=4&atClass=2">2반</a></li>
						<li><a href="studentView.do?atGrade=4&atClass=3">3반</a></li>
					</ul></li>
