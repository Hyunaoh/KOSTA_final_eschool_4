...
<body>
	...
	<form name="insertSchoolViolence.do" action="insertSchoolViolence.do"
		method="post">
		<table width="600">
			<tr>
				<th>순번</th>
			...
			<tr>
				<th>학년</th>
				<td><!-- <input type="text" name="svGrade" maxlength="5" size="12" /> -->
					<select id="svGrade" name="svGrade" title="학년을 선택하세요.">
			...
			<tr>
				<th>반</th>
				<td><input type="text" name="svSchoolClass" maxlength="12"
					size="13" /></td>
			</tr>
			...
			<tr>
				...
				<!-- <input type="text" name="svCategoly" maxlength="12" size="13" /> -->
					<select id="svCategoly" name="svCategoly" title="건의사항 종류를 선택하세요.">
			...
			<tr>
				<th>제목</th>
				<td><input type="text" name="svTitle" maxlength="50" size="65" />
				</td>
			</tr>
			<tr>
				<th>내용</th>
				<td><textarea name="svMessage" rows="5" cols="50"></textarea></td>
			</tr>
			<tr>
