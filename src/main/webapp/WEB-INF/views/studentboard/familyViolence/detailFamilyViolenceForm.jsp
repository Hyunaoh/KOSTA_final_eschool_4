...
<body>
	...
	<div class="row" style="float:left; width: 60%;">
		...
		<div class="matchingLocal">
					...
					<div class="m_p">
					<h3 align="left"> </h3>
					<h4>건의사항 종류 : ${fmNum.fmCategoly}</h4> 
					</div>
				</div>
				<br>
				<hr>
				...
				<a class="btn-del button" href="deleteFamilyViolence.do?fmNum=${fmNum.fmNum}">삭제</a>
		</div>	
